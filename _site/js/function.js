...
var helpers = {
    ...
    itemData: function (object) {
        ...
        var item = {
            ...
            produk: object.getAttribute('data-produk'),
            warna: object.getAttribute('data-warna'),
            model: object.getAttribute('data-model'),
            harga: object.getAttribute('data-harga'),
            id: object.getAttribute('data-id'),
            count: count.value,
            total: parseInt(object.getAttribute('data-harga')) * parseInt(count.value)
    ...
    emptyView: function () {
        ...
        this.setHtml('cartItems', '<p><center>Keranjang Belanja Kosong</center></p>');
        this.updateTotal();
...
var cart = {
    ...
    addItem: function (item) {
        ...
        this.total += item.harga * item.count;
